...
{
	?>
<div class="d-flex col-12 justify-content-between flex-wrap flex-md-nowrap section-metal">
    <div class="section-metal-image">
        <img src="<?=$arResult['DETAIL_PICTURE']['SRC']?>" alt="<?=$arResult['DETAIL_PICTURE']['ALT']?>">
    </div>
    <div class="section-metal-text col-12 col-md-6">
        <h1><?=$arResult['NAME']?></h1>
