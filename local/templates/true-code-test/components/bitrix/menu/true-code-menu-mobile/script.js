(function (window) {
  ...
  BX.CatalogMenu = {
    ...
    getItem: function (item) {
      ...
      var id =
        !item.id || !BX.type.isNotEmptyString(item.id)
          ? (item.id = "menu-item-" + this.idCnt++)
          : item.id;
    ...
    removeHover: function (curItem) {
      ...
      var items = curItem.parentNode.querySelectorAll(
  ...
  var CatalogMenuItem = function (item) {
    this.element = item;
    this.popup = BX.findChild(
      item,
      { className: "bx_children_container" },
      false,
      false
    );
  ...
  CatalogMenuItem.prototype.itemOver = function () {
    if (!BX.hasClass(this.element, "bx-hover")) {
      ...
      var popup = BX.findChild(
        this.element,
        { className: "bx-nav-2-lvl-container" },
        true,
        false
      );
      if (popup) {
        var popupRightEdge =
          popup.getBoundingClientRect().left + popup.offsetWidth;
...
BX.Main.MenuComponent.CatalogHorizontal = (function () {
  ...
  CatalogHorizontal.prototype.resizeMenu = function () {
    ...
    var menuMobile = document.body.querySelector(
      "[data-role='bx-menu-mobile']"
    );
    var menuMobileButton = document.body.querySelector(
      "[data-role='bx-menu-button-mobile']"
    );
    var menuMobilePosition = document.body.querySelector(
