...
?><div id="<? echo $strContID; ?>" class="header-block_container-width_lg traineeship-slider banner-block_indent_lg">
    <div class="swiper" id="js-traineeship-slider">
	<div class="traineeship-slider__wrapper swiper-wrapper">
		<?
		$boolFirst = true;
		$arRowIDs = array();
...
<!--			<div id="--><?// echo $strRowID; ?><!--" class="bx_catalog_tile_slide --><?// echo ($boolFirst ? 'active' : 'notactive'); ?><!--">-->
                ...
                <div class="swiper-slide">
					<div class="traineeship-slider__slide <? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>">
                            <div class="traineeship-slider__image">
                                <img alt="<? echo $imgTitle; ?>" src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>">
                            </div>
                        <div class="traineeship-slider__info">
                            <h3 class="traineeship-slider__title"><? echo $productTitle; ?></h3>
                            <div class="traineeship-slider__buttons">
                                <a class="btn-form traineeship-slider__link" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>">Подробнее</a>
                                <button class="btn-form traineeship-slider__btn" type="button">Подать заявку</button>
                            </div>
                        </div>
                    </div>
							<?
...
//				'className' => 'traineeship-slider__btn-prev bx_catalog_tile_slider_arrow_left'
//			),
//			'right' => array(
//				'id' => $strContID.'_right_arr',
//				'className' => 'traineeship-slider__btn-next bx_catalog_tile_slider_arrow_right'
//			),
//			'rows' => $arRowIDs,
...
////	?>
    ...
    <div class="traineeship-slider__pagination">
        <div class="traineeship-slider__btn-prev">
            <svg width="11" height="15" viewBox="0 0 11 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                        d="M3.3583e-07 7.50002C3.23793e-07 7.76885 0.132052 8.03765 0.395601 8.24261L8.69309 14.6923C9.22091 15.1026 10.0767 15.1026 10.6043 14.6923C11.1319 14.2822 11.1319 13.6171 10.6043 13.2068L3.26222 7.50002L10.604 1.79323C11.1316 1.38295 11.1316 0.717947 10.604 0.307862C10.0764 -0.10262 9.22065 -0.10262 8.69283 0.307862L0.395344 6.75744C0.131753 6.9625 3.47863e-07 7.23129 3.3583e-07 7.50002Z" />
            </svg>
        </div>
        <div class="traineeship-slider__btn-next">
            <svg width="11" height="15" viewBox="0 0 11 15" fill="none" xmlns="http://www.w3.org/2000/svg"
                 class="traineeship-slider_svg-next_big">
                <path
                        d="M11 7.49998C11 7.23114 10.8679 6.96235 10.6044 6.75739L2.30691 0.307713C1.77909 -0.102571 0.923317 -0.102571 0.395707 0.307713C-0.131902 0.71783 -0.131902 1.3829 0.395707 1.79322L7.73778 7.49998L0.395963 13.2068C-0.131647 13.617 -0.131647 14.2821 0.395963 14.6921C0.923572 15.1026 1.77935 15.1026 2.30717 14.6921L10.6047 8.24256C10.8682 8.0375 11 7.76871 11 7.49998Z" />
            </svg>
            <svg width="25" height="15" viewBox="0 0 25 15" fill="none" xmlns="http://www.w3.org/2000/svg"
                 class="traineeship-slider_svg-next_small">
                <path
                        d="M1.2217 3.77419L11.0978 13.6503C11.8682 14.4166 13.1125 14.4166 13.8828 13.6503L23.7589 3.77419C24.3929 3.03548 24.3929 1.94317 23.7589 1.20447C23.0498 0.376812 21.8015 0.28009 20.9738 0.989209L12.5002 9.46278L4.00678 0.989107C3.2364 0.222713 1.99208 0.222712 1.2217 0.989107C0.45531 1.75949 0.45531 3.00391 1.2217 3.77419Z"
                        fill="#352958" />
            </svg>
        </div>
    </div>
