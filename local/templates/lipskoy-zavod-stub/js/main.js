...
function openNav() {
  ...
  document.getElementById("menuBar").classList.remove("menuZIndex");
  document.getElementById("menuPhone").classList.remove("menuZIndex");
  document.querySelector(".breadcrumbs").style.zIndex = "0";
}

function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
  document.getElementById("menuBar").classList.add("menuZIndex");
  document.getElementById("menuPhone").classList.add("menuZIndex");
  document.querySelector(".breadcrumbs").style.zIndex = "100";
}